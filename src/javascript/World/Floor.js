...
export default class Floor
{
    constructor(_options)
    {
        ...
        this.colors = {}
        this.colors.topLeft = '#050b14'      // Deep Space Blue
        this.colors.topRight = '#1a0826'     // Midnight Purple
        this.colors.bottomRight = '#0d1527'  // Dark Cyber Blue
        this.colors.bottomLeft = '#03121a'   // Deep Oceanic Teal
