...
export default class Project
{
    ...
    setBoards()
    {
        ...
        for(const _imageSource of this.imageSources)
        {
            ...
            // Create structure with physical collisions
            this.objects.add({
    ...
    /**
     * Creates clean 3D text floor texture alpha maps automatically matching Bruno Simon's material shader
     */
    createFloorAlphaMap(text)
    {
        ...
        // Black background = complete transparency on the ground
        ctx.fillStyle = '#000000'
        ctx.fillRect(0, 0, canvas.width, canvas.height)

        // White text = visible text stencil on floor
        ctx.fillStyle = '#ffffff'
        ctx.font = '900 75px "Montserrat", "Arial Black", sans-serif'
    ...
    setFloor()
    {
        ...
        // Check for custom baked texture, fallback to dynamic generator
