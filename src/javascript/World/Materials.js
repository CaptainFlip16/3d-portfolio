...
export default class Materials
{
    ...
    setPures()
    {
        ...
        this.pures.items = {}
        // Neon Cyber Pink
        this.pures.items.red = new THREE.MeshBasicMaterial({ color: 0xff0055 })
        this.pures.items.red.name = 'pureRed'
        
        // Cyber Cyan/White
        this.pures.items.white = new THREE.MeshBasicMaterial({ color: 0x00f3ff })
        this.pures.items.white.name = 'pureWhite'
        
        // Neon Electric Yellow
        this.pures.items.yellow = new THREE.MeshBasicMaterial({ color: 0xffe600 })
    ...
    setShades()
    {
        ...
        // Cyberpunk Ambient Bounce Color (Cool Cyan / Deep Blue)
        this.shades.indirectColor = '#002b45'
    ...
    setFloorShadow()
    {
        ...
        // Soft deep cyan-tinted dark shadow matching ground ambient glow
        this.items.floorShadow.shadowColor = '#040a12'
